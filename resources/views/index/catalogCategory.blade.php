...
@section('Page')  
      ...
      <section class='sec' data-aos="fade-up" data-aos-duration="1500">
         ...
         <div class="search-container">
            ...
            <form  action= "{{route('search.category', $category)}}"  method="get" id="Forms">
               <div class="forms">
                  <input type='text' name='search' class = 'search'  placeholder='Rechercher dans {{$category}}'  value="{{ $searchTerm ?? '' }}">
    ...
    @foreach ($articles as $article) 
        <div class = 'card'>
        <div class='img'><a href="/article/{{ $article['id'] }}"><img src="/assets/Images/{{$article['path'] }} "  alt='' class='product-img'></a></div>
        <div class='bas'>
